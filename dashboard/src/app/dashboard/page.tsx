    ...
    <div className="flex h-full flex-col p-6 space-y-6">
      ...
      <div className="flex flex-1 gap-6 overflow-hidden">
        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          <Card className="glass-panel flex-1 relative overflow-hidden border-2 border-primary/20 bg-black flex items-center justify-center shadow-lg shadow-primary/5">
            {/* Video Stream */}
            {!streamError ? (
              <img 
        ...
        <div className="w-80 flex flex-col gap-4">
          {/* Live Event Log */}
          <Card className="glass-panel flex-1 flex flex-col min-h-0 border-2 border-border/60 bg-card shadow-lg shadow-black/5">
